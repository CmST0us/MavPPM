...
# 目录
<!-- TOC -->autoauto- [TODO](#todo)auto- [基于移动端重力感应的无人机遥控系统](#基于移动端重力感应的无人机遥控系统)auto- [摘要](#摘要)auto- [Abs...](#abs)auto- [目录](#目录)auto    - [术语说明](#术语说明)auto- [前言](#前言)auto    - [设计意义](#设计意义)auto    - [设计依据](#设计依据)auto        - [TCP通信](#tcp通信)auto        - [usbmuxd通信](#usbmuxd通信)auto            - [usbmuxd协议](#usbmuxd协议)auto            - [设备监听请求](#设备监听请求)auto            - [设备连接请求](#设备连接请求)auto        - [mavlink协议](#mavlink协议)auto        - [PPM协议](#ppm协议)auto        - [iOS系统](#ios系统)auto        - [Linux系统](#linux系统)auto    - [设计内容](#设计内容)auto        - [移动设备](#移动设备)auto        - [外设](#外设)auto        - [高频头](#高频头)auto    - [文献综述](#文献综述)auto- [总体方案确定](#总体方案确定)auto    - [方案比较](#方案比较)auto    - [方案选择](#方案选择)auto        - [通信方案](#通信方案)auto        - [硬件方案](#硬件方案)auto        - [软件方案](#软件方案)auto- [理论分析及设计](#理论分析及设计)auto    - [理论计算与分析](#理论计算与分析)auto        - [重力感应控制原理](#重力感应控制原理)auto    - [系统、配件、程序设计](#系统配件程序设计)auto        - [系统数据流设计](#系统数据流设计)auto        - [通信层代码设计](#通信层代码设计)auto            - [通信接口](#通信接口)auto            - [事件回调](#事件回调)auto            - [运行循环](#运行循环)auto            - [线程安全](#线程安全)auto        - [重力感应控制层代码设计](#重力感应控制层代码设计)auto            - [接口设计](#接口设计)auto            - [多数据获取](#多数据获取)auto        - [APP设计](#app设计)auto            - [链路管理模块](#链路管理模块)auto            - [mavlink数据包监听分发模块](#mavlink数据包监听分发模块)auto            - [通道绑定模块](#通道绑定模块)auto            - [控制反馈模块](#控制反馈模块)auto            - [姿态指示控件](#姿态指示控件)auto        - [外设控制程序设计](#外设控制程序设计)auto            - [mavlink数据包监听分发模块](#mavlink数据包监听分发模块-1)auto            - [持久化储存模块](#持久化储存模块)auto            - [PPM信号转换接口设计](#ppm信号转换接口设计)auto            - [链路管理模块](#链路管理模块-1)auto        - [硬件设计](#硬件设计)auto        - [仿真系统设计](#仿真系统设计)auto            - [PX4 仿真系统接入](#px4-仿真系统接入)auto    - [外设元器件选择](#外设元器件选择)auto- [测试与实验分析](#测试与实验分析)auto    - [测试、调试结果与分析](#测试调试结果与分析)auto    - [模型制作、加工](#模型制作加工)auto    - [实验、仿真结果与分析](#实验仿真结果与分析)auto- [总结](#总结)auto- [参考文献](#参考文献)auto- [附录](#附录)auto- [致谢](#致谢)autoauto<!-- /TOC -->
